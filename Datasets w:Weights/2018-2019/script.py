...
attendance = pd.read_excel('18-19 Attendance.xlsx')
enrollment = pd.read_excel('2018-2019 Enrollment.xlsx')
...
merged.to_excel('18-19 merged.xlsx', index=False)
...
county_weighted.to_excel('18-19 County_weighted.xlsx', index=False)