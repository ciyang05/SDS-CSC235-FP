...
attendance = pd.read_excel('2020-2021/20-21 Attendance.xlsx')
enrollment = pd.read_excel('2020-2021/20-21 Enrollment.xlsx')
...
merged.to_excel('20-21 merged.xlsx', index=False)
...
county_weighted.to_excel('20-21 County_weighted.xlsx', index=False)