...
attendance = pd.read_excel('2019-2020/19-20 Attendance.xlsx')
enrollment = pd.read_excel('2019-2020/2019-2020 Enrollment.xlsx')
...
merged.to_excel('19-20 merged.xlsx', index=False)
...
county_weighted.to_excel('19-20 County_weighted.xlsx', index=False)