...
attendance = pd.read_excel('2021-2022/21-22 Attendance.xlsx')
enrollment = pd.read_excel('2021-2022/21-22 Enrollment.xlsx')
...
merged.to_excel('21-22 merged.xlsx', index=False)
...
county_weighted.to_excel('21-22 County_weighted.xlsx', index=False)