...
attendance = pd.read_excel('2022-2023/22-23 Attendance.xlsx')
enrollment = pd.read_excel('2022-2023/22-23 Enrollment.xlsx')
...
merged.to_excel('22-23 merged.xlsx', index=False)
...
county_weighted.to_excel('22-23 County_weighted.xlsx', index=False)