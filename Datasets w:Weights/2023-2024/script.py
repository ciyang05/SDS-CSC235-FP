...
attendance = pd.read_excel('2023-2024/23-24 Attendance.xlsx')
enrollment = pd.read_excel('2023-2024/23-24 Enrollment.xlsx')
...
merged.to_excel('23-24 merged.xlsx', index=False)
...
county_weighted.to_excel('23-24 County_weighted.xlsx', index=False)