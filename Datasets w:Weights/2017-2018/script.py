...
attendance = pd.read_excel('17-18 Attendance.xlsx')
enrollment = pd.read_excel('2017-2018 Enrollment.xlsx')
...
merged.to_excel('17-18 merged.xlsx', index=False)
...
county_weighted.to_excel('17-18 County_weighted.xlsx', index=False)